...
/// <summary>
/// Node to use inside a graph view, to declare a KillSpecificResident
/// </summary>
public class EventKillSpecificResidentNode : GraphNode
{
    public EventKillSpecificResident KillSpecificResident = new EventKillSpecificResident();
    ...
    {
        ObjectField objectField = CreateElementsUtilities.CreateObjectField("Resident Data", KillSpecificResident.Resident, typeof(ResidentData), x => KillSpecificResident.Resident = x.newValue as ResidentData);
