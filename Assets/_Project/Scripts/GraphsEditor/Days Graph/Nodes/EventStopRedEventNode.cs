...
/// <summary>
/// Node to use inside a graph view, to declare a EventStopRedEvent
/// </summary>
public class EventStopRedEventNode : GraphNode
{
    public EventStopRedEvent EventStopRedEvent = new EventStopRedEvent();
