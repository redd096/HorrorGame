...
namespace redd096.NodesGraph.Editor
{
    ...
    public class NodesGraphToolbar : VisualElement
    {
        ...
        protected virtual void ClickSave()
        {
            ...
            //save file
            filePathInProject = EditorUtility.SaveFilePanelInProject("Save file", fileName, "asset", "Select folder where save file", filePanelStartFolder);
            Save();
        }
        ...
        protected virtual void ClickLoad()
        {
            ...
            string filePath = EditorUtility.OpenFilePanel("Load Graph", filePanelStartFolder, "asset");
